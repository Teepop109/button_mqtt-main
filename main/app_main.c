...
static void mqtt_event_handler(void *handler_args, esp_event_base_t base, int32_t event_id, void *event_data)
{
    ...
    case MQTT_EVENT_CONNECTED:
        ...
        esp_mqtt_client_subscribe(client, "KMITL/SIET/65030109/LED", 1); // Subscribe to the LED control topic
        break;
    ...
    case MQTT_EVENT_DATA:
        ...
        if (strncmp(event->topic, "KMITL/SIET/65030109/LED", event->topic_len) == 0) {
...
static void button_task(void *arg)
{
    ...
    int msg_id = esp_mqtt_client_publish(client, "KMITL/SIET/65030109/Button", message, 0, 1, 0);
